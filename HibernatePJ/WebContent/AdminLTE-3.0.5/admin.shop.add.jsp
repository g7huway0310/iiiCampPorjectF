			...
			<div class="row">
				<div class="col-md-10">
					<div class="card card-primary">
						...
						<div class="card-body">
							<form action="${path}AdminProductServlet?action=add"
								...
								<div class="form-group">
									<label for="exampleFormControlSelect1">商品種類</label> <select
										class="form-control" id="exampleFormControlSelect1" name=cato>
										<option value="1"
